...
#            print(compare,stack)
            ...
            if d == compare[0][1]:
                stack.append(compare.pop())
                compare.append([w,d])
#                print(compare,stack)
            elif (d > compare[0][1]) & (w > compare[0][0]):
                while (len(stack) != 0) & (d > compare[0][1]) & (w > compare[0][0]):
                    compare.pop()
                    compare.append(stack.pop())
#                    print(compare,stack)
                if (d > compare[0][1]) & (w < compare[0][0]):
                    pass
                else:
                    stack.append(compare.pop())
                    compare.append([w,d])
...
#                print(compare,stack)
    ...
    return len(stack) + len(compare)
    
A = [4,3,5,8,12,41,23,14,17,1]
